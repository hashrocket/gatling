%Gatling.Env{available_port: 4001,
 available_tasks: ["run", "app.start", "app.tree", "archive", "archive.build",
  ...
  "local", "local.hex", "local.public_keys", "local.rebar", "new",
  "phoenix.new", "profile.fprof", "run", "test", "xref"],
 ...
 script_template: "#!/bin/sh\n\n### BEGIN INIT INFO\n# Provides:          sample_project\n# Required-Start:    $local_fs $network $named $time $syslog\n# Required-Stop:     $local_fs $network $named $time $syslog\n# Default-Start:     2 3 4 5\n# Default-Stop:      0 1 6\n# Description:       Plug Application: sample_project\n### END INIT INFO\n\nexport MIX_ENV=prod\nexport PORT=4001\nexport HOME=/Users/dev/deployments/sample_project\n\n/Users/dev/deployments/sample_project/bin/sample_project \"$1\" \"$2\"\n",
